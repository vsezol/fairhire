  ...
  en: {
    translation: {
      ...
      systemInfo: {
        ...
        suspiciousDetected: 'Suspicious detected',
        noData: 'System information not available',
        virtualMachine: 'Virtual Machine',
        unknown: 'Unknown',
        ram: 'RAM',
        disk: 'Disk Space',
        ...
        lowRAM: 'Low memory detected',
        lowDisk: 'Low disk space detected',
        lowCores: 'Few CPU cores detected',
        manyMonitors: 'Multiple monitors detected',
      },
    },
  },
  ru: {
    translation: {
      ...
      systemInfo: {
        ...
        monitors: 'Мониторы',
        coresUnit: 'ядер',
        monitorsUnit: 'мониторов',
        lowRAM: 'Обнаружено мало памяти',
        lowDisk: 'Обнаружено мало места на диске',
        lowCores: 'Обнаружено мало ядер ЦП',
        manyMonitors: 'Обнаружено много мониторов',
      },
    },
  },
};
